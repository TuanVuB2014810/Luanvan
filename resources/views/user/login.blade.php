    ...
    <div class="dangnhap row d-flex justify-content-between col-sm-6 mt-5 bg-white">
        ...
        <form  action="/post-login" method="POST" >
            ...
            @method('post')
               ...
               <div class="row">
               <div class="input-group col-12 flex-nowrap login_ttk col-12 d-flex justify-content-between">
                    <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-user"></i></span>
                    <input type="text" name="name" class="form-control login_ttk" placeholder="Tên người dùng"
                        aria-label="Username" aria-describedby="addon-wrapping" value="{{ old('name') }}">
                </div>
                @error('name')
                ...
                <div class="input-group flex-nowrap login_ttk mt-3">
                    ...
                    <input type="password" name="pass" class="form-control login_ttk" placeholder="Mật khẩu"
                        aria-label="Username" aria-describedby="addon-wrapping" value="{{ old('pass') }}">
                    <!-- Thêm icon mắt vào trong input-group-text -->
                ...
                <h6 class="text-center mt-4"><span class="line-through">Hoặc</span></h6>
                    ...
                    <a class="btn a_login_gg btn_login mocked-styled-18 b10u9umr"  href="{{ route('auth.google') }}">
                        <svg class="" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg"> 
                            ...
                            <path
                                ...
                                fill="#EB4335"></path>
                        </svg><b class="mx-2"> Đăng nhập bằng Google</b>
                    </a>
                ...
                <p class=" px-1 py-1 col-12 text-center"> Chưa có tài khoản? <a href="/register" class="no-underline"> Đăng ký tài khoản</a></p>
               </div>

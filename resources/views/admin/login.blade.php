...
<body>
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="ad_assets/team.jpg" alt="IMG">
                </div>
                <!--=====TIÊU ĐỀ======-->
                <div class="login100-form validate-form">
                    <span class="login100-form-title">
                        <b>ĐĂNG NHẬP QUẢN TRỊ VIÊN</b>
                    </span>
                    <!--=====FORM INPUT TÀI KHOẢN VÀ PASSWORD======-->
                    <form action="" method="post">
                    @csrf  
                        <div class="wrap-input100 validate-input">
                            <input class="input100" type="text" placeholder="Người dùng" name="name" id="user">
    ...
    <!--Javascript-->
    <script src="ad_assets/js/main.js"></script>
    <script src="https://unpkg.com/boxicons@latest/dist/boxicons.js"></script>
    <script src="ad_assets/vendor/jquery/jquery-3.2.1.min.js"></script>
    <script src="ad_assets/vendor/bootstrap/js/popper.js"></script>
    <script src="ad_assets/vendor/bootstrap/js/bootstrap.min.js"></script>
    <script src="ad_assets/vendor/select2/select2.min.js"></script>
